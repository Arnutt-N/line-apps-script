...
5. Configure script properties:
   ...
   - `LINE_CHANNEL_SECRET`
   - `LINE_OA_ID`
   - `WEBHOOK_PROXY_SHARED_SECRET` (optional, when using the Cloudflare webhook proxy)
...
- A ready-to-deploy Cloudflare Worker webhook proxy is included in `cloudflare/line-webhook-proxy/` for LINE webhook verification and 302 mitigation.

## Documentation
- Thai docs index: `DOCS_INDEX_TH.md`
- Docs changelog: `DOCS_CHANGELOG_TH.md`
- Full deploy manual: `DEPLOYMENT_MANUAL_TH.md`
- Cloudflare webhook proxy: `CLOUDFLARE_WEBHOOK_PROXY_TH.md`
